...
# nvshmem variant of grpo_megatron_generation_non_colocated.sh: exercises MCore's
# NVSHMEM copy service for refit (requires NVSHMEM_MAX_CTAS, injected by lm_policy).
